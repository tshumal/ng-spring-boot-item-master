# Simple Spring Boot and AngularJS WebAp
This simple webapp demonstrates how **Spring Boot**, **Spring Data JPA** and **AngularJS** can be used together to write web applications easily.
This is a full CRUD-based web application with only about 150 lines of code (100 lines of Java code and 50 lines of JavaScript code).
I use **HSQLDB** as my in memory database for rapid prototyping.
...
```
mvn clean package && java -jar target\ng-spring-boot-item-master-1.0.0.jar
```
